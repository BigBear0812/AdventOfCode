...
export const run = (fileContents) => {
  ...
  let result1 = accepted.reduce((total, part) => total += part.x + part.m + part.a + part.s, 0);
  ...
  let result2 = acceptedStates.reduce((total, state) => 
    total += (state.x.max - state.x.min + 1) 
