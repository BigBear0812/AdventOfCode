  ...
  for(let step = 0; step < steps; step++){
    ...
    for(let y = 0; y < maxY; y++){
      ...
      for(let x = 0; x < maxX; x++){
        ...
        // Upper Left
        if(upperRow >= minY && upperRow < maxY && leftCol >= minX && leftCol < maxX)
        ...
        // Upper Right
        if(upperRow >= minY && upperRow < maxY && rightCol >= minX && rightCol < maxX)
        ...
        // Lover Left
        if(lowerRow >= minY && lowerRow < maxY && leftCol >= minX && leftCol < maxX)
        ...
        // Lower Right
        if(lowerRow >= minY && lowerRow < maxY && rightCol >= minX && rightCol < maxX)
