...
export const run = async (fileContents) => {
  ...
  // Calc part 1 answer 
  let result1 = regions.reduce((total, region) => total += region.area * region.perimeter, 0);
  // Calc part 2 answer
  let result2 = regions.reduce((total, region) => total += region.area * region.corners, 0);
