...
const evaluateMonkeys = (monkeys, monkeyKey, resolvedMonkeys, reversedMonkeys) => {
  ...
  // If this does match the regex then it is an expression
    ...
    if(resolvedMonkeys.has(monkey1))
      monkey1Val = resolvedMonkeys.get(monkey1);
    else if(parseInt(monkey1))
      monkey1Val = parseInt(monkey1);
    else
      monkey1Val = evaluateMonkeys(monkeys, monkey1, resolvedMonkeys, reversedMonkeys);
    if(resolvedMonkeys.has(monkey2))
      monkey2Val = resolvedMonkeys.get(monkey2);
      else if(parseInt(monkey2))
      monkey2Val = parseInt(monkey2);
    else
      monkey2Val = evaluateMonkeys(monkeys, monkey2, resolvedMonkeys, reversedMonkeys);
      ...
      if (!monkey1Val){
        ...
        // some extra steps to properly rearrange subtration and division operations.
          ...
          if(reversedOperator === '+')
            ...
            reversedExp = monkeyKey + ' ' + reversedOperator + ' ' + monkey1
